...
<section class="mb-10 min-h-screen grid place-content-center px-5">
	<div class="mx-auto max-w-screen-lg">
		<div class="p-8">
			...
			<h1 class="mt-6 text-center text-4xl font-medium text-gray-700"> Indeks Kepuasan Masyarakat </h1>
		...
		<div class="grid grid-cols-2 gap-5 md:grid-cols-4">
			<div class="rounded-xl border p-8 shadow text-center">
				<div class="flex h-16 w-16 mx-auto items-center justify-center rounded-full bg-red-100 text-red-500 shadow-2xl">
			...
			<div class="rounded-xl border p-8 shadow text-center">
				<div class="flex h-16 w-16 mx-auto items-center justify-center rounded-full bg-orange-100 text-orange-500 shadow-2xl">
			...
			<div class="rounded-xl border p-8 shadow text-center">
				<div class="flex h-16 w-16 mx-auto items-center justify-center rounded-full bg-yellow-100 text-yellow-500 shadow-2xl">
			...
			<div class="rounded-xl border p-8 shadow text-center">
				<div class="flex h-16 w-16 mx-auto items-center justify-center rounded-full bg-green-100 text-green-500 shadow-2xl">
	...
	<div class="mx-auto max-w-screen-lg px-4 py-8 sm:px-6 lg:px-8">
		<div class="sm:flex sm:items-center sm:justify-between">
			<a href="{{ route('index') }}" class="flex items-center">
				<img src="{{ asset('assets/LOGO RSUD.png') }}" class="mr-3 h-8" alt="Logo" />
				<span class="self-center whitespace-nowrap text-2xl font-medium dark:text-white">{{ config('app.name') }}</span>
			</a>
			<p class="mt-4 text-center text-sm text-gray-500 lg:mt-0 lg:text-right">
				Copyright &copy; IT RSUD Mayjen H.A. Thalib Kota Sungai Penuh. |
				<a href="https://wa.me/6282289735137" target="_blank">Hubungi Kami</a>
			</p>
